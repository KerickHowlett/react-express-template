module.exports = {
    types: [
        { value: 'build', name: 'build: Establishing infrastructure, altering major dependencies, CI/CD, or Docker.' },
    ...
    scopes: [
        ...
        { name: 'assets', description: 'Adding or removing assets (i.e., images or PDFs).' },
        { name: 'ci', description: 'CI/CD pipelines related.' },
        { name: 'devcontainer', description: 'Anything related to the devcontainer.' },
        { name: 'docker', description: 'Anything related to a Dockerfile or environment.' },
        { name: 'library', description: 'Anything related to a particular library.' },
        { name: 'linter', description: 'Anything Linter specific (ESLint or Stylelint).' },
        { name: 'misc', description: 'Literally, anything.' },
        { name: 'repo', description: 'Anything related to managing the repo itself.' },
        { name: 'styles', description: 'Anything related to styles (i.e., SCSS or CSS).' },
        { name: 'tests', description: 'Anything testing specific (i.e., jest or cypress).' }
    ],
    messages: {
